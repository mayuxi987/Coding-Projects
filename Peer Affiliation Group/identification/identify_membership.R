dataset_matrix <- read.csv("C:/Users/Yuki/Downloads/100703_matrix.csv", header=FALSE)
...
dataset_membership <-read.csv ("C:/USERS/YUKI/DOWNLOADS/100703_membership.csv", header = TRUE)
